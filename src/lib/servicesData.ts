...
export const servicesData: Record<Lang, ServiceDetail[]> = {
  en: [
    ...
    },
    {
      ...
      tiers: [
        { label: "Single Seat", price: "₪70" },
        { label: "All Seats - Cars", price: "₪200" },
        { label: "All Seats - Minivans / SUVs", price: "₪240" },
        { label: "All Seats - Full-Size Trucks / Vans", price: "₪280" },
      ],
  ...
  he: [
    ...
    },
    {
      ...
      tiers: [
        { label: "כסא בודד", price: "₪70" },
        { label: "כל הכסאות - רכב פרטי", price: "₪200" },
        { label: "כל הכסאות - מיניוואן / רכב שטח (SUV)", price: "₪240" },
        { label: "כל הכסאות - טנדר / ואן גדול", price: "₪280" },
      ],
